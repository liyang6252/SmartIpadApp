package com.leonyr.calendarview;
...
import com.leonyr.calendarview.format.ArrayWeekDayFormatter;
import com.leonyr.calendarview.format.DayFormatter;
import com.leonyr.calendarview.format.MonthArrayTitleFormatter;
import com.leonyr.calendarview.format.TitleFormatter;
import com.leonyr.calendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
  ...
  /**
   * Set a {@linkplain com.leonyr.calendarview.format.WeekDayFormatter}
   * with the provided week day labels
   *
   * @param weekDayLabels Labels to use for the days of the week
   * @see com.leonyr.calendarview.format.ArrayWeekDayFormatter
   * @see #setWeekDayFormatter(com.leonyr.calendarview.format.WeekDayFormatter)
   */
  ...
  /**
   * Set a {@linkplain com.leonyr.calendarview.format.TitleFormatter}
   * using the provided month labels
   *
   * @param monthLabels month labels to use
   * @see com.leonyr.calendarview.format.MonthArrayTitleFormatter
   * @see #setTitleFormatter(com.leonyr.calendarview.format.TitleFormatter)
   */
