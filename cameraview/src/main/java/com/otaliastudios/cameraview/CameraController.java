...
//            selector = SizeSelectors.or(mPictureSizeSelector, SizeSelectors.biggest());
        ...
        List<Size> results = selector.select(list);
        Collections.sort(results, new Comparator<Size>() {
            @Override
        ...
        Size result = results.get(0);
        LOG.i("computePictureSize:", "result:", result.toString(), "flip:", flip);
